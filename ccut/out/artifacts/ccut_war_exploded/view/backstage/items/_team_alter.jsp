    ...
    <form id="form1" class="layui-form" style="width: 95%;" method="post" lay-filter="test1">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  lay-verify="title" name="name"  class="layui-input" value="<%=request.getParameter("name")%>">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-upload-list">
                    <img id="demo1" class="layui-upload-img" width="150" height="150" src="<c:url value='/upload/photos/'/><%=request.getParameter("photo")%>?date=<%=new Date().getTime()%>">
                    <p id="demoText"></p>
                </div>
            </div>
        </div>
...
<script>
    layui.use('upload', function() {
        ...
        var uploadInst = upload.render({
            elem: '#test1'
            ,url: "${pageContext.request.contextPath}/adminTeamMemberPhotoAlter.action?id=<%=request.getParameter("id")%>"
            ,field: 'newPhoto'
            ,accept: 'images'
            ,acceptMime: 'image/*'
            , before: function (obj) {
            ...
            , done: function (res) {
                ...
                parent.updateImg('<%=request.getParameter("id")%>', img)
    ...
    function  alter() {
        layui.use('layer', function() {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/adminTeamMemberAlter.action",
                type: "POST",
                cache:false,
