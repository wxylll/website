    ...
    <div class="container-fluid" style="padding: 0px;height: 100%">
        <div class="row" style="width: 100%;height: 6%;background-color: #c30;margin-left: 0px;float: left;display: table;vertical-align:middle;">
            <div style="vertical-align:middle;display: table-cell">
                <span style="margin-left: 4%;color: white;float: left;font-size: 30px;font-weight: bold;">网络工程</span>
            </div>
        ...
        <div style="background-color: rgb(238,238,238);height: 94%;width: 15%;float: left">
            <ul id="nav" class="list-unstyled" style="margin-top: 20px">
                <li class="my_nav" onclick="nav_switch(this)">
                    <a href="<c:url value="/adminNewsManage.action"/>" target="content">支部新闻</a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                </li>
                <li class="my_nav" onclick="nav_switch(this)">
                    <a href="<c:url value="/adminStudyManage.action"/>" target="content">学习园地</a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                </li>
                <li class="my_nav" onclick="nav_switch(this)">
                    <a href="<c:url value="/adminMemberManage.action"/>" target="content">班子成员</a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                </li>
                <li class="my_nav" onclick="nav_switch(this)">
                    <a href="<c:url value="/adminTeamManage.action"/>" target="content">党员队伍</a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                </li>
            </ul>
        </div>
