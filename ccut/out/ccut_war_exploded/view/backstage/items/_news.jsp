...
<body>
 <div class="container-fluid">
     ...
     <div class="title"><span>新闻管理</span></div>
     <div class="articles">
...
<script>
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{title:'操作',unresize:true, templet:function(d) {
                    return "<button class='layui-btn btn_position' onclick='slideAlter("+ d.id + "," + d.aid +")'>设置</button>" +
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('确定要删除这篇新闻吗？',
                    ...
                    function(index){
                    $.ajax({
                        url:'${pageContext.request.contextPath}/adminNewsDelete.action?id=' + data.id,
                        type:'get',
                        success:function () {
                            layer.msg('删除成功！')
                        },
    ...
    function search() {
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/adminNewsSearch.action?title=' + text,
            type:'get',
    ...
    function newsAlter(id) {
        var index = layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: ['${pageContext.request.contextPath}/adminGetNews.action?id=' + id]
        })
    ...
    function newsAdd() {
        var index = layer.open({
            ...
            fixed: false, //不固定
            maxmin: true,
            content: ['${pageContext.request.contextPath}/view/backstage/items/_news_article_add.jsp']
        })
        layui.layer.full(index);
    }
