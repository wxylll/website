...
<div style="width: 100%;padding-top: 20px">
    <form id="form1" class="layui-form" style="width: 95%;" method="post" lay-filter="test1">
        ...
        <div class="layui-form-item">
            <label lay-verify="required" class="layui-form-label">政治面貌</label>
            <div class="layui-input-block">
                <input type="text" name="politicsStatus" lay-verify="title"  class="layui-input" value="${member.politicsStatus}">
            </div>
        </div>
        <div align="center">
