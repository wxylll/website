...
public class MemberController {
    ...
    public String addMember(String name, String position, String politicsStatus, MultipartFile photo, HttpServletRequest request) {
    ...
    public String alterMember(int id, String name, String position, String politicsStatus) {
        try {
