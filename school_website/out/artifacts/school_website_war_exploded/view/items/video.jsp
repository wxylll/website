...
<style type="text/css">
    ...
    .text {font-family: '仿宋_GB2312','FangSong_GB2312','仿宋','FangSong','微软雅黑','宋体'!important;font-size: 30px;overflow: hidden;line-height: 65px!important;}
...
<div style="width:75%;padding-top:50px;background-color: white;" align="center" class="container-fluid">
    <h1 style="padding: 10px;margin-bottom: 20px">${video.title}</h1>
    <span>发布时间：<fmt:formatDate value="${video.releaseTime}" pattern="yyyy-MM-dd"/></span>
    <hr style="height: 2px">
    <div align="center" class="text" style="width: 100%;min-height: 80%;padding-top: 20px;padding-bottom: 30px">
        <video style="height: 600px;width: 1000px" controls="controls" autoplay="autoplay">
            <source src="<c:url value="/upload/video/${video.video}"/>" type="video/mp4" />
        </video>
    </div>
</div>
